...
Beaver's CLI, its future embedded web app, and direct hand-editing are all thin
...
contradicting ADR 0001 and Beaver's premise. Keeping every interface a thin
