...
- **List ready work** → `beaver list --ready`, which is dependency-aware and sorted priority-first: an issue is ready when it's todo and every dependency is done. Drop any result labelled `needs-review`.
