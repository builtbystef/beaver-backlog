...
Editing `internal/web/styles/tailwind.css` or any web template also means regenerating the design system's stylesheet with `./scripts/build-css.sh` and committing its output; CI fails on drift.
